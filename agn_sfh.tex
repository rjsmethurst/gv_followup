...
%MAIN RESULT
Here we present the first observational population study of the SFH of AGN host galaxies, in comparison with a population inactive galaxies using a Bayesian method. We find evidence for an AGN host galaxy to have undergone a recent and rapid drop in its star formation rate. 
%RESULT COMPARISON
