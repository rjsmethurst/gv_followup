...
Conversely, this rapid quenching, caused by the AGN itself through negative feedback, is the most dominant history for low mass galaxies with lower gravitational potentials which allow gas to be expelled more easily (or heated by the AGN) across the entire galaxy \citep{Torbra09}. Rapid quenching is particularly dominant for low-to-medium mass smooth galaxies. \cite{Sme2015} speculate that incredibly rapid quenching rates could be attributed to mergers of galaxies in conjunction with AGN feedback, which are thought to be responsible for creating the most massive smooth galaxies \citep{Con03, SdMH05, Hopkins08}. This dominance of rapid quenching supports the idea that a merger, having caused a morphological transformation, could also trigger an AGN in these smooth galaxies \citep{Sch2014}. 
