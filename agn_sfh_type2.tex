...
%RESULT COMPARISON
This result is not seen for the inactive galaxies whose SFHs are dominated by the effects of downsizing at earlier epochs, a secondary effect for the AGN host galaxies. We show that rapid quenching histories cannot account fully for the quenching of all the star formation in a galaxy's lifetime, across the population of AGN host galaxies and that slower quenching histories, attributed to non-violent processes of evolution are also key in their evolution.
%RESULTS IN GENERAL CONTEXT
This is in agreement with recent results showing both merger-driven and non-merger processes are contributing to the co-evolution of galaxies and super massive black holes. The availability of gas in the reservoirs of a galaxy, and its ability to be replenished, appears to be the key driver behind this co-evolution.\footnotemark[1]
%BROAD PERSPECTIVE
...
\cite{Simmons11} showed that the obscuration of a Type 2 AGN is more efficient in the NUV than in the optical. Residual NUV flux from the AGN can be neglected in comparison to that of the galaxy, however there is often some residual optical flux that can affect the measurements of the host galaxy's photometry. We can subtract this central optical AGN flux using the PSF magnitudes provided by SDSS, however the change in the colours of these galaxies after this correction is negligible, with $\Delta(u-r) \sim 0.09$. We therefore use the uncorrected colours to avoid unnecessary complexity and minimise the propagation of errors in the the SFH likelihoods. Including these corrected colours does not change the results described below.  

Images from SDSS for ten randomly selected Type 2 AGN host galaxies from this sample are shown in Figure \ref{mosaic} and the entire sample is shown in Figure \ref{bpt} with those galaxies selected as Type 2 AGN marked in red and the rest of the \textsc{gz2-galex} in black.  For this sample the mean $\log L[OIII] \sim 41.3$ and median $\log L[OIII] \sim 41.0$, with a range of $\log L[OIII]$ luminosities of $39.4-43.0$. 
...
We also split both the \textsc{agn-host} and \textsc{inactive} samples into low, medium and high masses (see Table \ref{massbins}) to investigate any trends in the SFH with mass. Masses were calculated using the $u-r$ colour and absolute r-band magnitude with the method outlined in \cite{Baldry06}.
...
The differences between the distribution of likelihood for the \textsc{agn-host} and \textsc{inactive} galaxy populations reveal that AGN have a significant effect on the SFH of its host galaxy. Both recent, rapid quenching and early, slow quenching are observed in the likelihood distribution of the \textsc{agn-host} population. 
...
The difference between the \textsc{agn-host} and \textsc{inactive} population distribution of likelihood in Figure \ref{rate} for the rate of quenching, $\tau$, tells a story of gas reservoirs. The likelihood distribution of higher mass \textsc{agn-host} galaxies is dominated by slower, early quenching implying another mechanism is responsible for the cessation of star formation in these high mass galaxies prior to the triggering of the current AGN.  This preference for slower evolution timescales follows from the ideas of previously isolated discs evolving slowly by the Kennicutt-Schmidt \citep{Schmidt59, Kennicutt97} law which can then undergo an interaction or merger to reinvigorate star formation, feed the central black hole and trigger a current AGN \citep{Varela04, Em15}. This challenges the typical merger-driven theory for the co-evolution of the most luminous black holes and their host galaxies. 

If we consider the most massive smooth galaxies having undergone a slower, early quenching history through downsizing so that it becomes a slowly `dying' or `dead' galaxy typical of massive elliptical galaxies. Such a galaxy can then have an infall of gas either through a minor merger, galaxy interaction or environmental change, triggering further star formation and feeding the central black hole, igniting an AGN \citep{Kav14}. In turn this AGN can then quench the recent boost in star formation. This track is similar to the evolution history theorised for blue ellipticals \citep{Kav13, McIntosh14, Haines15}.

These recently ignited AGN in these massive disc and smooth galaxies do not have have the ability to impact across the entirety of such a high mass galaxy in a deep gravitational potential \citep{Ish12, Zinn13}. This leads to the less dominant peak for recent, rapid quenching in the high mass \textsc{agn-host} population for both morphologies. 
...
These slow, early quenching histories are also observed for the \textsc{inactive} population, where the likelihood distribution for the quenching time is roughly constant until early times where the distribution drops off. This drop off occurs at earlier times with increasing mass. This is observational evidence of downsizing across the \textsc{inactive} galaxy population whereby stars in massive galaxies form first and quench early \citep{Cowie96, Thomas10}. This preference for early, slow quenching across the most massive \textsc{agn-host} population could also be caused by downsizing early in the galaxy's history with the currently triggered AGN, rapidly quenching any residual star formation. This SFH would also give rise to the distribution of the likelihood seen across the \textsc{agn-host} population along with the histories outlined above.

Conversely, rapid quenching, perhaps caused by the AGN itself through negative feedback, is the most dominant history for low mass galaxies with lower gravitational potentials which allow gas to be expelled more easily (or heated by the AGN) across the entire galaxy \citep{Torbra09}. Rapid quenching is particularly dominant for low-to-medium mass smooth galaxies. \cite{Sme2015} speculate that rapid quenching rates could be attributed to mergers of galaxies, which are thought to be responsible for creating the most massive smooth galaxies \citep{Con03, SdMH05, Hopkins08}. This dominance of rapid quenching supports the idea that a merger, having caused a morphological transformation, could also trigger an AGN in these smooth galaxies \citep{Sch2014}. 
